USE [IAS]
GO
/****** Object:  StoredProcedure [graphdb].[GenerateNodes]    Script Date: 17/11/2025 2:59:17 AM ******/
DROP PROCEDURE [graphdb].[GenerateNodes]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetViews]    Script Date: 17/11/2025 2:59:17 AM ******/
DROP PROCEDURE [graphdb].[api_GetViews]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetNodeTypes]    Script Date: 17/11/2025 2:59:17 AM ******/
DROP PROCEDURE [graphdb].[api_GetNodeTypes]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetNodeLegends]    Script Date: 17/11/2025 2:59:17 AM ******/
DROP PROCEDURE [graphdb].[api_GetNodeLegends]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetItems]    Script Date: 17/11/2025 2:59:17 AM ******/
DROP PROCEDURE [graphdb].[api_GetItems]
GO
/****** Object:  StoredProcedure [graphdb].[api_Expand]    Script Date: 17/11/2025 2:59:17 AM ******/
