USE [IAS]
GO
/****** Object:  StoredProcedure [graphdb].[sp_NodesGenerate]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[sp_NodesGenerate]
GO
/****** Object:  StoredProcedure [graphdb].[api_ViewsGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_ViewsGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_ViewColumnItemsGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_ViewColumnItemsGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_RelationsGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_RelationsGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_RelationSave]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_RelationSave]
GO
/****** Object:  StoredProcedure [graphdb].[api_RelationDelete]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_RelationDelete]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodeUpdate]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodeUpdate]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodeTypesGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodeTypesGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodesGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodesGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodeLegendsGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodeLegendsGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodeExpand_backup]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodeExpand_backup]
GO
/****** Object:  StoredProcedure [graphdb].[api_NodeExpand]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_NodeExpand]
GO
/****** Object:  StoredProcedure [graphdb].[api_GroupNodeGet]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP PROCEDURE [graphdb].[api_GroupNodeGet]
GO
/****** Object:  StoredProcedure [graphdb].[api_Expand]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  Index [UQ_Relations_Source_Search_Display]    Script Date: 11/19/2025 2:13:22 PM ******/
ALTER TABLE [graphdb].[Relations] DROP CONSTRAINT [UQ_Relations_Source_Search_Display]
GO
/****** Object:  Table [graphdb].[ViewRegistry]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  Table [graphdb].[RelationsData]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  Table [graphdb].[Relations]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  Table [graphdb].[Nodes]    Script Date: 11/19/2025 2:13:22 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[graphdb].[Nodes]') AND type in (N'U'))
DROP TABLE [graphdb].[Nodes]
GO
/****** Object:  Table [graphdb].[IncidentsData]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  Table [graphdb].[GroupNode]    Script Date: 11/19/2025 2:13:22 PM ******/
...
GO
/****** Object:  UserDefinedTableType [graphdb].[IntList]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP TYPE [graphdb].[IntList]
GO
/****** Object:  UserDefinedTableType [graphdb].[ExpandDateFilter]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP TYPE [graphdb].[ExpandDateFilter]
GO
/****** Object:  Schema [graphdb]    Script Date: 11/19/2025 2:13:22 PM ******/
DROP SCHEMA [graphdb]
GO
/****** Object:  Schema [graphdb]    Script Date: 11/19/2025 2:13:22 PM ******/
...
CREATE PROCEDURE [graphdb].[api_GroupNodeGet]
 @Lang       nvarchar(2)
AS
BEGIN

select  GroupNodeID , CASE WHEN @Lang = N'ar' THEN GroupNodeAr ELSE GroupNodeEn END AS  GroupNode
from  [graphdb].[GroupNode] order by GroupNode
...
BEGIN
  ...
  FROM #Out o
  INNER JOIN graphdb.Nodes n
    ON N.IsActive=1 AND n.Column_ID = o.displayCol
  INNER JOIN graphdb.GroupNode g
...
BEGIN
  ...
  BEGIN
    SELECT TOP (0)
      ...
      CAST(NULL AS int)           AS GroupNodeID,
      CAST(NULL AS nvarchar(10))  AS GroupNodeTag,
      CAST(NULL AS nvarchar(200)) AS GroupNodeLabel,
      CAST(NULL AS nvarchar(20))  AS ColumnColor;
    RETURN;
  END;
  ...
  DECLARE
    @GroupNodeID  int = NULL,
    @GroupNodeTag nvarchar(10) = NULL,
    @GroupNodeEn  nvarchar(200) = NULL,
    @GroupNodeAr  nvarchar(200) = NULL,
    @ColumnColor  nvarchar(20) = '#87cefa';

  SELECT
    @GroupNodeID  = n.GroupNodeID,
    @GroupNodeTag = g.GroupNodeTag,
    @GroupNodeEn  = g.GroupNodeEn,
    @GroupNodeAr  = g.GroupNodeAr,
    @ColumnColor  = n.ColumnColor
  FROM graphdb.Nodes n
  LEFT JOIN graphdb.GroupNode g ON g.GroupNodeID = n.GroupNodeID
  WHERE n.Column_ID = @ColId;

  DECLARE @GroupNodeLabel nvarchar(200) =
    CASE WHEN @Lang = N'ar'
         THEN COALESCE(@GroupNodeAr, @GroupNodeEn, @GroupNodeTag)
         ELSE COALESCE(@GroupNodeEn, @GroupNodeAr, @GroupNodeTag)
    END;

  DECLARE @sql nvarchar(max) = N'
    SELECT DISTINCT TOP('+CAST(@MaxCount AS nvarchar(10))+N')
      id,
      [text],
      @GNID  AS GroupNodeID,
      @GNTAG AS GroupNodeTag,
      @GNLBL AS GroupNodeLabel,
      @COLOR AS ColumnColor
    FROM (' + @selects + N') AS X
    ORDER BY [text];';

  EXEC sp_executesql
    @sql,
    N'@GNID int, @GNTAG nvarchar(10), @GNLBL nvarchar(200), @COLOR nvarchar(20)',
    @GNID  = @GroupNodeID,
    @GNTAG = @GroupNodeTag,
    @GNLBL = @GroupNodeLabel,
    @COLOR = @ColumnColor;
END
GO
/****** Object:  StoredProcedure [graphdb].[api_ViewsGet]    Script Date: 11/19/2025 2:13:22 PM ******/
