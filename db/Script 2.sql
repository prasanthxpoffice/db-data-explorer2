USE [IAS]
GO
/****** Object:  StoredProcedure [graphdb].[UpdateNode]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[UpdateNode]
GO
/****** Object:  StoredProcedure [graphdb].[SaveRelation]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[SaveRelation]
GO
/****** Object:  StoredProcedure [graphdb].[GetRelations]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[GetRelations]
GO
/****** Object:  StoredProcedure [graphdb].[GetNodes]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[GetNodes]
GO
/****** Object:  StoredProcedure [graphdb].[GenerateNodes]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[GenerateNodes]
GO
/****** Object:  StoredProcedure [graphdb].[DeleteRelation]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[DeleteRelation]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetViews]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[api_GetViews]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetNodeTypes]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[api_GetNodeTypes]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetNodeLegends]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[api_GetNodeLegends]
GO
/****** Object:  StoredProcedure [graphdb].[api_GetItems]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[api_GetItems]
GO
/****** Object:  StoredProcedure [graphdb].[api_Expand]    Script Date: 11/17/2025 2:22:46 PM ******/
DROP PROCEDURE [graphdb].[api_Expand]
GO
ALTER TABLE [graphdb].[Nodes] DROP CONSTRAINT [DF_SeedCol_IsActive]
GO
/****** Object:  Index [UQ_Relations_Source_Search_Display]    Script Date: 11/17/2025 2:22:46 PM ******/
ALTER TABLE [graphdb].[Relations] DROP CONSTRAINT [UQ_Relations_Source_Search_Display]
GO
/****** Object:  Table [graphdb].[ViewRegistry]    Script Date: 11/17/2025 2:22:46 PM ******/
...
GO
/****** Object:  Table [graphdb].[RelationsData]    Script Date: 11/17/2025 2:22:46 PM ******/
...
GO
/****** Object:  Table [graphdb].[Relations]    Script Date: 11/17/2025 2:22:46 PM ******/
...
GO
/****** Object:  Table [graphdb].[Nodes]    Script Date: 11/17/2025 2:22:46 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[graphdb].[Nodes]') AND type in (N'U'))
DROP TABLE [graphdb].[Nodes]
GO
/****** Object:  Table [graphdb].[IncidentsData]    Script Date: 11/17/2025 2:22:46 PM ******/
...
GO
INSERT [graphdb].[Nodes] ([Column_ID], [ColumnEn], [ColumnAr], [IsActive], [ColumnColor]) VALUES (N'ID_A_ID', N'Incident', N'حادثة', 1, N'#b8b8ff')
GO
INSERT [graphdb].[Nodes] ([Column_ID], [ColumnEn], [ColumnAr], [IsActive], [ColumnColor]) VALUES (N'ID_B_ID', N'Person', N'شخص', 1, N'#85ffb4')
GO
INSERT [graphdb].[Nodes] ([Column_ID], [ColumnEn], [ColumnAr], [IsActive], [ColumnColor]) VALUES (N'ID_C_ID', N'Vehicle', N'عربة', 1, N'#ffffc2')
GO
INSERT [graphdb].[Nodes] ([Column_ID], [ColumnEn], [ColumnAr], [IsActive], [ColumnColor]) VALUES (N'ID_D_ID', N'Weapon', N'سلاح', 1, N'#b3ffff')
GO
INSERT [graphdb].[Nodes] ([Column_ID], [ColumnEn], [ColumnAr], [IsActive], [ColumnColor]) VALUES (N'ID_R_ID', N'Relation', N'العلاقة', 1, N'#ffb8ff')
GO
...
SET QUOTED_IDENTIFIER ON
GO
CREATE   PROCEDURE [graphdb].[api_GetNodeLegends]
  @Lang       nvarchar(2),                 -- 'en' | 'ar'
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [graphdb].[DeleteRelation]
    @RelationID INT
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [graphdb].[GetNodes]
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [graphdb].[GetRelations]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [graphdb].[SaveRelation]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [graphdb].[UpdateNode]
